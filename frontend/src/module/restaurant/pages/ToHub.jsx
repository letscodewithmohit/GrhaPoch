...
export default function ToHub() {
  ...
  const calculateChartDataFromOrders = (orders, startDate, endDate) => {
    ...
    filteredOrders.forEach((order) => {
      ...
      let hourLabel;
      if (hour >= 0 && hour < 4) hourLabel = "12am";else
      if (hour >= 4 && hour < 8) hourLabel = "4am";else
      if (hour >= 8 && hour < 12) hourLabel = "8am";else
      if (hour >= 12 && hour < 16) hourLabel = "12pm";else
      if (hour >= 16 && hour < 20) hourLabel = "4pm";else
      hourLabel = "8pm"; // 20-23
