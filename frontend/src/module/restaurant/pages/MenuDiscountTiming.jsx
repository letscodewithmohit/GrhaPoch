...
export default function MenuDiscountTiming() {
  ...
  const { discountCards, priceCards, discountConstruct, selectedItems, discountType } = location.state || {};
  ...
  const getBackPath = () => {
    ...
    if (discountType === "flat-price-menu") return "/restaurant/hub-growth/create-offers/delight-customers/flat-price";
    if (discountType === "bogo-menu") return "/restaurant/hub-growth/create-offers/delight-customers/bogo";
  ...
  discountType === "flat-price-menu" && priceCards && priceCards.length > 0 ||
  discountType === "bogo-menu" && discountConstruct && selectedItems && selectedItems.length > 0);
