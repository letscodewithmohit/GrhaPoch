          ...
          <div className="relative z-20 w-full px-3 sm:px-6 lg:px-8">
            ...
            <div className="z-20">
              ...
              <div className="w-full relative">
                <div 
                  onClick={() => openSearch()}
                  className="relative bg-white dark:bg-[#1a1a1a] rounded-xl lg:rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-1 sm:p-1.5 transition-all duration-300 hover:shadow-xl cursor-pointer">
