        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-green-600 mb-1">{disbursementStatsDeliverymen.pending}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-slate-900 mb-1">{disbursementStatsDeliverymen.completed}</p>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 relative">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-2xl font-bold text-red-600 mb-1">{disbursementStatsDeliverymen.canceled}</p>
