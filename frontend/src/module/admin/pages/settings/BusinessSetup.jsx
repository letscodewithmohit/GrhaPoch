  ...
  const handleSave = async () => {
    try {
      ...
      const dataToSend = {
        ...
        approvalTime: formData.approvalTime.trim(),
      };
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200">
          ...
          <div className="px-4 py-4 border-t border-slate-100">
            <h3 className="text-sm font-semibold text-slate-900 mb-4 flex items-center gap-2">
              <span>Delivery Bank Deposit Details</span>
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Approval Time</label>
                <input
                  type="text"
                  placeholder="e.g., 24-48 hours"
                  value={formData.approvalTime}
                  onChange={(e) => handleInputChange("approvalTime", e.target.value)}
                  className="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
