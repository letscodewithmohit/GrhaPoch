...
import RestaurantSubscriptionRequests from "../pages/restaurant/RestaurantSubscriptionRequests";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="restaurants/subscription-requests" element={<RestaurantSubscriptionRequests />} />
