...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    DELIVERY_BANK_DEPOSITS: '/admin/delivery-bank-deposits',
    DELIVERY_BANK_DEPOSIT_APPROVE: '/admin/delivery-bank-deposits/:id/approve',
    DELIVERY_BANK_DEPOSIT_REJECT: '/admin/delivery-bank-deposits/:id/reject',
