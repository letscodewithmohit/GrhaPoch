...
export function decrypt(encryptedText) {
  ...
  try {
    ...
    // Decryption fails when ENCRYPTION_KEY changed or data format invalid - return '' silently
    // Enable DEBUG_DECRYPTION=true in .env to log errors
    if (process.env.DEBUG_DECRYPTION === 'true') {
